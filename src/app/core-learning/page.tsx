...
import { phase1, phase2, phase3, phase4, phase5, phase6, phase7, phase8, phase9, phase10, phase11, phase12, phase13, phase14, phase15, phase16, phase17, phase18, phase19, phase20, phase21, phase22, phase23, phase24, phase25, phase26, phase27, phase28, phase29, phase30, phase31 } from '@/data/vocabulary';
    ...
    const [phases, setPhases] = useState<Phase[]>(() =>
        Array.from({ length: 31 }, (_, i) => {
            ...
            if (id === 31) {
                return {
                    id: 31,
                    title: `Phase 31: ${phase31.title}`,
                    wordCount: phase31.words.length,
                    status: 'locked',
                };
            }
